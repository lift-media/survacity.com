...
$_SESSION['gmail_access_token'] = '{"access_token":"ya29.Ci-QA0H8MboapTINXQhPsH7icCV0-C4zOdrI1V37t0ffVNdJOjXwImm9rmQibSQfRw","token_type":"Bearer","expires_in":3600,"refresh_token":"1/KhpZWL-otLsDmR9tGjfnk0LRLqctpLwgDqm1zTfGqKI","created":1478760735}';
...
if (isset($_SESSION['gmail_access_token']) && !empty($_SESSION['gmail_access_token']) ) {
    ...
    $strRawMessage .= "To: 93 Robot <ashish.kumar@srmtechsol.com>\r\n";
